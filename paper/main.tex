...
$50.5\,\%$ of an applied unit force on average while still correlating with ground
truth at $0.997$, so a validation that looks convincing can hide a large gain
error. The magnitude of that loss depends on the characteristic length that makes
