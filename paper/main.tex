...
\author{{[Author One]}\authorrefmark{1},
{[Author Two]}\authorrefmark{2}
and {[Author Three]}\authorrefmark{2}}

\address[1]{[Affiliation 1] (e-mail: author1@example.org)}
\address[2]{[Affiliation 2] (e-mail: author2@example.org)}

\tfootnote{[Funding statement.]}

\markboth
{[Author] \headeretal:~Sensorless Force Estimation for Velocity-Actuated Arms}
{[Author] \headeretal:~Sensorless Force Estimation for Velocity-Actuated Arms}

\corresp{Corresponding author: [Author One] (e-mail: author1@example.org).}
